...
def error_response(message='An internal server error occurred', status_code=500, log_error=Optional[str]):
...
def get_event_by_id(event_id: str):
    ...
    try:
        ...
        return error_response(f'Error fetching event by ID {event_id}: {e}', log_error=e)
